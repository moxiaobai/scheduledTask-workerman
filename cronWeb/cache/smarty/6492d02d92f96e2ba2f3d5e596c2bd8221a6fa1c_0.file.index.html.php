<?php /* Smarty version 3.1.27, created on 2016-09-26 16:20:51
         compiled from "/mnt/outsource/timer/cronWeb/application/views/index/index.html" */ ?>
<?php
/*%%SmartyHeaderCode:99636043557e8da63c4d9c7_14217710%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6492d02d92f96e2ba2f3d5e596c2bd8221a6fa1c' => 
    array (
      0 => '/mnt/outsource/timer/cronWeb/application/views/index/index.html',
      1 => 1474878050,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '99636043557e8da63c4d9c7_14217710',
  'variables' => 
  array (
    'id' => 0,
    'title' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57e8da63edf471_07401505',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57e8da63edf471_07401505')) {
function content_57e8da63edf471_07401505 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '99636043557e8da63c4d9c7_14217710';
...
" class="input-big form-control" placeholder="任务内容">
        <?php echo $_smarty_tpl->tpl_vars['directorOption']->value;?>
...
?>
    <tr>
        ...
        <td><?php echo $_smarty_tpl->tpl_vars['director']->value[$_smarty_tpl->tpl_vars['row']->value['d_id']];?>
</td>
...
<br />
        ...
        <td>
            <?php if ($_smarty_tpl->tpl_vars['row']->value['c_type'] == 1) {?><span class="badge badge-success">Curl方式运行</span><?php } else { ?><span class="badge badge-info">Cli方式运行</span><?php }?><br />
            <?php echo $_smarty_tpl->tpl_vars['row']->value['c_content'];?>

        </td>
        <td>
            <span class="label label-success">启动时间:</span><?php echo $_smarty_tpl->tpl_vars['row']->value['c_run_time'];?>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-important">停止时间:</span><?php echo $_smarty_tpl->tpl_vars['row']->value['c_stop_time'];?>
<br />
            <span class="label label-info">添加时间:</span><?php echo $_smarty_tpl->tpl_vars['row']->value['c_addtime'];?>
&nbsp;&nbsp;&nbsp;&nbsp;<span class="label label-warning">编辑时间:</span><?php echo $_smarty_tpl->tpl_vars['row']->value['c_update_time'];?>
<br />
        </td>
        <td>
